...
// Provides an interface to take an action based on the output from the expression
// detection model.

#ifndef TENSORFLOW_LITE_MICRO_EXAMPLES_EXPRESSION_DETECTION_DETECTION_RESPONDER_H_
#define TENSORFLOW_LITE_MICRO_EXAMPLES_EXPRESSION_DETECTION_DETECTION_RESPONDER_H_
...
#endif  // TENSORFLOW_LITE_MICRO_EXAMPLES_EXPRESSION_DETECTION_DETECTION_RESPONDER_H_
